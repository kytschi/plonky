...
class Plonky
{
        ...
        try {
            ...
            for file in files {
                if (strpos(file, ".json") !== false) {
                    let this->projects[] = json_decode(file_get_contents(this->projects_folder . file));
                }
            }
            this->build();
        } catch \Exception, err {
    ...
    private function build()
    {
        ...
        echo "</head><body><div id='projects'>
            <div class='toolbar'>
                <div class='icon' onclick='showAbout()'>
        ...
        <div id='about' class='popover hide'>
            <div class='box'>
                <div class='box-title'>About Plonky</div>
    ...
    /**
     * All the css that is used for the app.
     */
    ...
    /**
     * All the javscript that is used for the app.
     */
